// Debubbing : Debubbing is the process of identifying and fixing the errors in the program.
...
// Logic to get sum of the two numbers
function sumofnumbers(a, b) {
    c = a + b;
    console.log(c);
}

// Debubbing the program step by step.

// 1. At the break points (before the line where we want manually execute the program)
